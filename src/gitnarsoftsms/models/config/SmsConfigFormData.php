 ...
 */
class SmsConfigFormData extends ActiveRecord
{

    public static function collectionName()
    {
        return 'sms_config_form_data';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['sms_config_id', 'data_key', 'data_value', 'description'], 'safe']
        ];
    }

    public function attributes()
    {
        return ['_id', 'sms_config_id', 'data_key', 'data_value', 'description', 'updated_at', 'created_at'];
    }
